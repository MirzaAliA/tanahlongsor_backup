  ...
  <body class="font-ews bg-[#F6F4EB]">
    ...
    <section class="my-12 lg:my-16 xl:my-20">
      <div class="mx-5 sm:mx-7 md:mx-8 lg:mx-12">
        <h1 class="text-xl sm:text-[21px] md:text-[22px] lg:text-2xl xl:text-3xl font-semibold text-center">LANGKAH MITIGASI TANDA-TANDA UTAMA BENCANA TANAH LONGSOR</h1>
      ...
      <div class="mx-5 sm:mx-7 md:mx-8 lg:mx-12 md:grid md:grid-cols-2 gap-5 md:gap-8 xl:gap-10">
        <div class="bg-[#B0D9B1] rounded-lg flex h-[90px] sm:h-[110px] border border-black border-opacity-30">
          <div class="bg-white px-2 py-2 rounded-lg mr-5 w-[100px]">
            <img src="../assets/siaga 1.png" class=" h-[50px] mt-3 sm:mt-0 sm:h-[90px] sm:w-[90px] mx-auto object-center object-cover">
          </div>
          <p class="text-[13px] sm:text-sm md:text-[14.5px] lg:text-[15px] xl:text-base mt-5 sm:mt-9">Munculnya retakan vertikal pada tebing. </p>
        </div>
        <div class="bg-[#B0D9B1] rounded-lg flex h-[90px] sm:h-[110px] border border-black border-opacity-30">
          <div class="bg-white px-2 py-2 rounded-lg mr-5 lg:w-[100px]">
            <img src="../assets/siaga 2.png" class=" h-[120px] mt-3 sm:mt-0 sm:h-[90px] sm:w-full mx-auto object-center object-cover">
          </div>
          <p class="text-[13px] sm:text-sm md:text-[14.5px] lg:text-[15px] xl:text-base mt-1 sm:mt-5 lg:mt-10">Munculnya air tanah secara tiba-tiba.
        </p>
        </div>
        <div class="bg-[#B0D9B1] rounded-lg flex h-[90px] sm:h-[110px] border border-black border-opacity-30">
          <div class="bg-white px-2 py-2 rounded-lg mr-5 lg:w-[100px]">
            <img src="../assets/siaga 3.png" class=" h-[80px] mt-3 sm:mt-0 sm:h-[90px] sm:w-full mx-auto object-center object-cover">
          </div>
          <p class="text-[13px] sm:text-sm md:text-[14.5px] lg:text-[15px] xl:text-base mt-1 sm:mt-5 lg:mt-10">Air sumur di sekitar tebing menjadi keruh.</p>
        </div>
        <div class="bg-[#B0D9B1] rounded-lg flex h-[90px] sm:h-[110px] border border-black border-opacity-30">
          <div class="bg-white px-2 py-2 rounded-lg mr-5 lg:w-[100px]">
            <img src="../assets/siaga 4.png" class=" h-[150px] mt-3 sm:mt-0 sm:h-[90px] sm:w-full mx-auto object-center object-cover">
          </div>
          <p class="text-[13px] sm:text-sm md:text-[14.5px] lg:text-[15px] xl:text-base mt-1 sm:mt-5 lg:mt-10">Adanya longsoran batu-batu kecil.</p>
        </div>
      </div>
    </section>
    ...
    <div class="bg-[#63B578] w-full py-10 flex">
     ...
     <div class="md:w-1/5 lg:w-1/3 mt-2">
      <div class="flex ">
